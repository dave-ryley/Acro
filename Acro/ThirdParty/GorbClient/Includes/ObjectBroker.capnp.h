...
struct Gorb::ObjectBroker::ModifyResults {
  ...
  struct _capnpPrivate {
    CAPNP_DECLARE_STRUCT_HEADER(d3a5da5426e11083, 0, 1)
    #if !CAPNP_LITE
    static constexpr ::capnp::_::RawBrandedSchema const* brand() { return &schema->defaultBrand; }
    #endif  // !CAPNP_LITE
  };
...
inline bool Gorb::ObjectBroker::ModifyResults::Reader::hasObject() const {
  return !_reader.getPointerField(
      ::capnp::bounded<0>() * ::capnp::POINTERS).isNull();
}
inline bool Gorb::ObjectBroker::ModifyResults::Builder::hasObject() {
  return !_builder.getPointerField(
      ::capnp::bounded<0>() * ::capnp::POINTERS).isNull();
}
inline  ::Gorb::Object::Reader Gorb::ObjectBroker::ModifyResults::Reader::getObject() const {
  return ::capnp::_::PointerHelpers< ::Gorb::Object>::get(_reader.getPointerField(
      ::capnp::bounded<0>() * ::capnp::POINTERS));
}
inline  ::Gorb::Object::Builder Gorb::ObjectBroker::ModifyResults::Builder::getObject() {
  return ::capnp::_::PointerHelpers< ::Gorb::Object>::get(_builder.getPointerField(
      ::capnp::bounded<0>() * ::capnp::POINTERS));
}
#if !CAPNP_LITE
inline  ::Gorb::Object::Pipeline Gorb::ObjectBroker::ModifyResults::Pipeline::getObject() {
  return  ::Gorb::Object::Pipeline(_typeless.getPointerField(0));
}
#endif  // !CAPNP_LITE
inline void Gorb::ObjectBroker::ModifyResults::Builder::setObject( ::Gorb::Object::Reader value) {
  ::capnp::_::PointerHelpers< ::Gorb::Object>::set(_builder.getPointerField(
      ::capnp::bounded<0>() * ::capnp::POINTERS), value);
}
inline  ::Gorb::Object::Builder Gorb::ObjectBroker::ModifyResults::Builder::initObject() {
  return ::capnp::_::PointerHelpers< ::Gorb::Object>::init(_builder.getPointerField(
      ::capnp::bounded<0>() * ::capnp::POINTERS));
}
inline void Gorb::ObjectBroker::ModifyResults::Builder::adoptObject(
    ::capnp::Orphan< ::Gorb::Object>&& value) {
  ::capnp::_::PointerHelpers< ::Gorb::Object>::adopt(_builder.getPointerField(
      ::capnp::bounded<0>() * ::capnp::POINTERS), kj::mv(value));
}
inline ::capnp::Orphan< ::Gorb::Object> Gorb::ObjectBroker::ModifyResults::Builder::disownObject() {
  return ::capnp::_::PointerHelpers< ::Gorb::Object>::disown(_builder.getPointerField(
      ::capnp::bounded<0>() * ::capnp::POINTERS));
}
